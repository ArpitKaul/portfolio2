...
const Contact = () => {
    ...
    const sendEmail = (e) => {
        ...
        emailjs
          .sendForm('service_1x50ncu', 'template_4wv62ej', formRef.current, {
            publicKey: 'rbDLWID43k0z3qR_A',
          })
          .then(
            (result) => {
                setSuccess(true)
  ...
  return (
    ...
    className='contact' variants={variants} initial="initial" whileInView="animate">
        ...
        <svg width="500px" height="500px" viewBox="0 0 24 24" fill="none"
